...
- API হল এমন একটা মিডিয়েটর বা যোগাযোগ মাধ্যম, যেটা দুইটা সফটওয়্যারের মধ্যে যোগাযোগ করায় — যেন একটার ডেটা আরেকটা নিতে বা দিতে পারে।

1. তুমি = ক্লায়েন্ট (Client)
2. রান্নাঘর = সার্ভার (Server)
3. ওয়েটার = API
4. ওয়েটার (API) তোমার রিকোয়েস্ট রান্নাঘরে (server) পৌঁছে দেয় এবং রান্নাঘর থেকে খাবার এনে তোমাকে দেয়।

## REST কী?
-  এটি একটি design rule / standard — যেটা বলে API কীভাবে বানাতে হবে যেন তা সহজে, দ্রুত, ও সুন্দরভাবে কাজ করে।
- GET → ডেটা পাওয়ার জন্য 
- POST → নতুন ডেটা পাঠানোর জন্য 
- PUT/PATCH → ডেটা আপডেট করার জন্য 
- DELETE → ডেটা ডিলিট করার জন্য
- REST মানে হচ্ছে: তুমি API তৈরি করলে সেটি কিছু স্ট্যান্ডার্ড নিয়ম ফলো করবে যেন অন্য ডেভেলপাররাও সহজে বুঝে কোড করতে পারে।

| বিষয়   | API                                                                      | REST API                                                  |
|--------|--------------------------------------------------------------------------|-----------------------------------------------------------|
| মানে   | API মানে যেকোনো ইন্টারফেস যেটা দুই সফটওয়্যারের মধ্যে ডেটা ট্রান্সফার করে | REST API হল সেই API যেটা REST design rule অনুযায়ী কাজ করে |
| নিয়ম   | সব API-তেই REST এর নিয়ম মানা লাগে না                                     | REST API অবশ্যই REST এর GET, POST, PUT, DELETE নিয়ম মানে  |
| উদাহরণ | File system API, Java API, Bluetooth API                                 | Instagram REST API, Firebase REST API                     |
